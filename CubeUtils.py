...
moveDict = {
    ...
    "U8": (28, 1), "U8'": (28, -1), "D8": (29, 1), "D8'": (29, -1),
    "U9": (30, 1), "U9'": (30, -1), "D9": (31, 1), "D9'": (31, -1),
    "U10": (32, 1), "U10'": (32, -1), "D10": (33, 1), "D10'": (33, -1),
    "U11": (34, 1), "U11'": (34, -1), "D11": (35, 1), "D11'": (35, -1),
    "U12": (36, 1), "U12'": (36, -1), "D12": (37, 1), "D12'": (37, -1),
    "U13": (38, 1), "U13'": (38, -1), "D13": (39, 1), "D13'": (39, -1),
    "U14": (40, 1), "U14'": (40, -1), "D14": (41, 1), "D14'": (41, -1),
    "U15": (42, 1), "U15'": (42, -1), "D15": (43, 1), "D15'": (43, -1),
    "U16": (44, 1), "U16'": (44, -1), "D16": (45, 1), "D16'": (45, -1),
    "U17": (46, 1), "U17'": (46, -1), "D17": (47, 1), "D17'": (47, -1),
    "U18": (48, 1), "U18'": (48, -1), "D18": (49, 1), "D18'": (49, -1),
    "U19": (50, 1), "U19'": (50, -1), "D19": (51, 1), "D19'": (51, -1),
    "U20": (52, 1), "U20'": (52, -1), "D20": (53, 1), "D20'": (53, -1),
    "U21": (54, 1), "U21'": (54, -1), "D21": (55, 1), "D21'": (55, -1),
    "U22": (56, 1), "U22'": (56, -1), "D22": (57, 1), "D22'": (57, -1),
    "U23": (58, 1), "U23'": (58, -1), "D23": (59, 1), "D23'": (59, -1),
    "U24": (60, 1), "U24'": (60, -1), "D24": (61, 1), "D24'": (61, -1),
    "U25": (62, 1), "U25'": (62, -1), "D25": (63, 1), "D25'": (63, -1)
}
